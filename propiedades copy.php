        ...
        <main class="main" id="main">
            <div class="main__container">
                ...
                <div class="propiedades">
                    ...
                    <?php
			        $whereOp="op.id = ".$_GET['op'];         
                    $whereTipo="tipo.id = ".$_GET['tipo'];
                    $whereCiudad="ciudad.id = ".$_GET['ciudad'];
                    $whereZona="zona.id = ".$_GET['zona'];
                    $wherePrecio="prop.precio_propietario BETWEEN ".$_GET['preciodesde']."AND".$_GET['preciohasta'];
                    $whereHabitaciones="prop.cant_habitaciones BETWEEN ".$_GET['habitacionesdesde']." AND ".$_GET['habitacioneshasta'];
                    $whereDomicilio="prop.calle LIKE '%".$_GET['domicilio']."%'";
                    $whereRef="prop.referencia_interna LIKE '%".$_GET['ref']."%'";
                    $wherePileta="prop.pileta_propia = ".$_GET['pileta']." OR prop.pileta_compartida = ".$_GET['pileta'];
                    $whereLlaves="prop.llavero = '".$_GET['llaves']."'";
                    $whereOcupada="prop.ocupada = ".$_GET['ocupada'];
                    $wherePlantaBaja="prop.planta_baja = ".$_GET['plantabaja'];
                    $whereEstado="prop.visible_web = ".$_GET['estado'];
                    ...
                    if($_GET['op'] != '' AND $_GET['tipo'] == '' AND $_GET['ciudad'] == '' AND $_GET['zona'] == '' AND $_GET['preciodesde'] == '' AND $_GET['habitacionesdesde'] == '' AND $_GET['domicilio'] == '' AND $_GET['ref'] == '' AND $_GET['pileta'] == '' AND $_GET['llaves'] == '' AND $_GET['ocupada'] == '' AND $_GET['plantabaja'] == '' AND $_GET['estado'] == ''){$filtro = "WHERE ".$whereOp." ";};
                    if($_GET['op'] == '' AND $_GET['tipo'] != '' AND $_GET['ciudad'] == '' AND $_GET['zona'] == '' AND $_GET['preciodesde'] == '' AND $_GET['habitacionesdesde'] == '' AND $_GET['domicilio'] == '' AND $_GET['ref'] == '' AND $_GET['pileta'] == '' AND $_GET['llaves'] == '' AND $_GET['ocupada'] == '' AND $_GET['plantabaja'] == '' AND $_GET['estado'] == ''){$filtro = "WHERE ".$whereTipo." ";};
                    if($_GET['op'] == '' AND $_GET['tipo'] == '' AND $_GET['ciudad'] != '' AND $_GET['zona'] == '' AND $_GET['preciodesde'] == '' AND $_GET['habitacionesdesde'] == '' AND $_GET['domicilio'] == '' AND $_GET['ref'] == '' AND $_GET['pileta'] == '' AND $_GET['llaves'] == '' AND $_GET['ocupada'] == '' AND $_GET['plantabaja'] == '' AND $_GET['estado'] == ''){$filtro = "WHERE ".$whereCiudad." ";};
                    if($_GET['op'] == '' AND $_GET['tipo'] == '' AND $_GET['ciudad'] == '' AND $_GET['zona'] != '' AND $_GET['preciodesde'] == '' AND $_GET['habitacionesdesde'] == '' AND $_GET['domicilio'] == '' AND $_GET['ref'] == '' AND $_GET['pileta'] == '' AND $_GET['llaves'] == '' AND $_GET['ocupada'] == '' AND $_GET['plantabaja'] == '' AND $_GET['estado'] == ''){$filtro = "WHERE ".$whereTipo." ";};
                    if($_GET['op'] == '' AND $_GET['tipo'] == '' AND $_GET['ciudad'] == '' AND $_GET['zona'] == '' AND $_GET['preciodesde'] != '' AND $_GET['habitacionesdesde'] == '' AND $_GET['domicilio'] == '' AND $_GET['ref'] == '' AND $_GET['pileta'] == '' AND $_GET['llaves'] == '' AND $_GET['ocupada'] == '' AND $_GET['plantabaja'] == '' AND $_GET['estado'] == ''){$filtro = "WHERE ".$whereTipo." ";};
                    if($_GET['op'] == '' AND $_GET['tipo'] == '' AND $_GET['ciudad'] == '' AND $_GET['zona'] == '' AND $_GET['preciodesde'] == '' AND $_GET['habitacionesdesde'] != '' AND $_GET['domicilio'] == '' AND $_GET['ref'] == '' AND $_GET['pileta'] == '' AND $_GET['llaves'] == '' AND $_GET['ocupada'] == '' AND $_GET['plantabaja'] == '' AND $_GET['estado'] == ''){$filtro = "WHERE ".$whereHabitaciones." ";};
                    if($_GET['op'] == '' AND $_GET['tipo'] == '' AND $_GET['ciudad'] == '' AND $_GET['zona'] == '' AND $_GET['preciodesde'] == '' AND $_GET['habitacionesdesde'] == '' AND $_GET['domicilio'] != '' AND $_GET['ref'] == '' AND $_GET['pileta'] == '' AND $_GET['llaves'] == '' AND $_GET['ocupada'] == '' AND $_GET['plantabaja'] == '' AND $_GET['estado'] == ''){$filtro = "WHERE ".$whereDomicilio." ";};
                    if($_GET['op'] == '' AND $_GET['tipo'] == '' AND $_GET['ciudad'] == '' AND $_GET['zona'] == '' AND $_GET['preciodesde'] == '' AND $_GET['habitacionesdesde'] == '' AND $_GET['domicilio'] == '' AND $_GET['ref'] != '' AND $_GET['pileta'] == '' AND $_GET['llaves'] == '' AND $_GET['ocupada'] == '' AND $_GET['plantabaja'] == '' AND $_GET['estado'] == ''){$filtro = "WHERE ".$whereRef." ";};
                    if($_GET['op'] == '' AND $_GET['tipo'] == '' AND $_GET['ciudad'] == '' AND $_GET['zona'] == '' AND $_GET['preciodesde'] == '' AND $_GET['habitacionesdesde'] == '' AND $_GET['domicilio'] == '' AND $_GET['ref'] == '' AND $_GET['pileta'] != '' AND $_GET['llaves'] == '' AND $_GET['ocupada'] == '' AND $_GET['plantabaja'] == '' AND $_GET['estado'] == ''){$filtro = "WHERE ".$wherePileta." ";};
                    if($_GET['op'] == '' AND $_GET['tipo'] == '' AND $_GET['ciudad'] == '' AND $_GET['zona'] == '' AND $_GET['preciodesde'] == '' AND $_GET['habitacionesdesde'] == '' AND $_GET['domicilio'] == '' AND $_GET['ref'] == '' AND $_GET['pileta'] == '' AND $_GET['llaves'] != '' AND $_GET['ocupada'] == '' AND $_GET['plantabaja'] == '' AND $_GET['estado'] == ''){$filtro = "WHERE ".$whereLlaves." ";};
                    if($_GET['op'] == '' AND $_GET['tipo'] == '' AND $_GET['ciudad'] == '' AND $_GET['zona'] == '' AND $_GET['preciodesde'] == '' AND $_GET['habitacionesdesde'] == '' AND $_GET['domicilio'] == '' AND $_GET['ref'] == '' AND $_GET['pileta'] == '' AND $_GET['llaves'] == '' AND $_GET['ocupada'] != '' AND $_GET['plantabaja'] == '' AND $_GET['estado'] == ''){$filtro = "WHERE ".$whereOcupada." ";};
                    if($_GET['op'] == '' AND $_GET['tipo'] == '' AND $_GET['ciudad'] == '' AND $_GET['zona'] == '' AND $_GET['preciodesde'] == '' AND $_GET['habitacionesdesde'] == '' AND $_GET['domicilio'] == '' AND $_GET['ref'] == '' AND $_GET['pileta'] == '' AND $_GET['llaves'] == '' AND $_GET['ocupada'] == '' AND $_GET['plantabaja'] != '' AND $_GET['estado'] == ''){$filtro = "WHERE ".$wherePlantaBaja." ";};
                    if($_GET['op'] == '' AND $_GET['tipo'] == '' AND $_GET['ciudad'] == '' AND $_GET['zona'] == '' AND $_GET['preciodesde'] == '' AND $_GET['habitacionesdesde'] == '' AND $_GET['domicilio'] == '' AND $_GET['ref'] == '' AND $_GET['pileta'] == '' AND $_GET['llaves'] == '' AND $_GET['ocupada'] == '' AND $_GET['plantabaja'] == '' AND $_GET['estado'] != ''){$filtro = "WHERE ".$whereEstado." ";};
                    if($_GET['op'] != '' AND $_GET['tipo'] != '' AND $_GET['ciudad'] != '' AND $_GET['zona'] != '' AND $_GET['preciodesde'] != '' AND $_GET['habitacionesdesde'] != '' AND $_GET['domicilio'] != '' AND $_GET['ref'] != '' AND $_GET['pileta'] != '' AND $_GET['llaves'] != '' AND $_GET['ocupada'] != '' AND $_GET['plantabaja'] != '' AND $_GET['estado'] != ''){$filtro = "WHERE ".$whereOp." AND ".$whereTipo." AND ".$whereCiudad." AND ".$whereTipo." AND ".$whereTipo." AND ".$whereHabitaciones." AND ".$whereDomicilio." AND ".$whereRef." AND ".$wherePileta." AND ".$whereLlaves." AND ".$whereOcupada." AND ".$wherePlantaBaja." AND ".$whereEstado." ";};
                    if($_GET['op'] != '' AND $_GET['tipo'] != '' AND $_GET['ciudad'] != '' AND $_GET['zona'] != '' AND $_GET['preciodesde'] != '' AND $_GET['habitacionesdesde'] != '' AND $_GET['domicilio'] != '' AND $_GET['ref'] != '' AND $_GET['pileta'] != '' AND $_GET['llaves'] != '' AND $_GET['ocupada'] != '' AND $_GET['plantabaja'] != '' AND $_GET['estado'] == ''){$filtro = "WHERE ".$whereOp." AND ".$whereTipo." AND ".$whereCiudad." AND ".$whereTipo." AND ".$whereTipo." AND ".$whereHabitaciones." AND ".$whereDomicilio." AND ".$whereRef." AND ".$wherePileta." AND ".$whereLlaves." AND ".$whereOcupada." AND ".$wherePlantaBaja." ";};
                    if($_GET['op'] != '' AND $_GET['tipo'] != '' AND $_GET['ciudad'] != '' AND $_GET['zona'] != '' AND $_GET['preciodesde'] != '' AND $_GET['habitacionesdesde'] != '' AND $_GET['domicilio'] != '' AND $_GET['ref'] != '' AND $_GET['pileta'] != '' AND $_GET['llaves'] != '' AND $_GET['ocupada'] != '' AND $_GET['plantabaja'] == '' AND $_GET['estado'] != ''){$filtro = "WHERE ".$whereOp." AND ".$whereTipo." AND ".$whereCiudad." AND ".$whereTipo." AND ".$whereTipo." AND ".$whereHabitaciones." AND ".$whereDomicilio." AND ".$whereRef." AND ".$wherePileta." AND ".$whereLlaves." AND ".$whereOcupada." AND ".$whereEstado." ";};
                    if($_GET['op'] != '' AND $_GET['tipo'] != '' AND $_GET['ciudad'] != '' AND $_GET['zona'] != '' AND $_GET['preciodesde'] != '' AND $_GET['habitacionesdesde'] != '' AND $_GET['domicilio'] != '' AND $_GET['ref'] != '' AND $_GET['pileta'] != '' AND $_GET['llaves'] != '' AND $_GET['ocupada'] == '' AND $_GET['plantabaja'] != '' AND $_GET['estado'] != ''){$filtro = "WHERE ".$whereOp." AND ".$whereTipo." AND ".$whereCiudad." AND ".$whereTipo." AND ".$whereTipo." AND ".$whereHabitaciones." AND ".$whereDomicilio." AND ".$whereRef." AND ".$wherePileta." AND ".$whereLlaves." AND ".$wherePlantaBaja." AND ".$whereEstado." ";};
                    if($_GET['op'] != '' AND $_GET['tipo'] != '' AND $_GET['ciudad'] != '' AND $_GET['zona'] != '' AND $_GET['preciodesde'] != '' AND $_GET['habitacionesdesde'] != '' AND $_GET['domicilio'] != '' AND $_GET['ref'] != '' AND $_GET['pileta'] != '' AND $_GET['llaves'] == '' AND $_GET['ocupada'] != '' AND $_GET['plantabaja'] != '' AND $_GET['estado'] != ''){$filtro = "WHERE ".$whereOp." AND ".$whereTipo." AND ".$whereCiudad." AND ".$whereTipo." AND ".$whereTipo." AND ".$whereHabitaciones." AND ".$whereDomicilio." AND ".$whereRef." AND ".$wherePileta." AND ".$whereOcupada." AND ".$wherePlantaBaja." AND ".$whereEstado." ";};
                    if($_GET['op'] != '' AND $_GET['tipo'] != '' AND $_GET['ciudad'] != '' AND $_GET['zona'] != '' AND $_GET['preciodesde'] != '' AND $_GET['habitacionesdesde'] != '' AND $_GET['domicilio'] != '' AND $_GET['ref'] != '' AND $_GET['pileta'] == '' AND $_GET['llaves'] != '' AND $_GET['ocupada'] != '' AND $_GET['plantabaja'] != '' AND $_GET['estado'] != ''){$filtro = "WHERE ".$whereOp." AND ".$whereTipo." AND ".$whereCiudad." AND ".$whereTipo." AND ".$whereTipo." AND ".$whereHabitaciones." AND ".$whereDomicilio." AND ".$whereRef." AND ".$whereLlaves." AND ".$whereOcupada." AND ".$wherePlantaBaja." AND ".$whereEstado." ";};
                    if($_GET['op'] != '' AND $_GET['tipo'] != '' AND $_GET['ciudad'] != '' AND $_GET['zona'] != '' AND $_GET['preciodesde'] != '' AND $_GET['habitacionesdesde'] != '' AND $_GET['domicilio'] != '' AND $_GET['ref'] == '' AND $_GET['pileta'] != '' AND $_GET['llaves'] != '' AND $_GET['ocupada'] != '' AND $_GET['plantabaja'] != '' AND $_GET['estado'] != ''){$filtro = "WHERE ".$whereOp." AND ".$whereTipo." AND ".$whereCiudad." AND ".$whereTipo." AND ".$whereTipo." AND ".$whereHabitaciones." AND ".$whereDomicilio." AND ".$wherePileta." AND ".$whereLlaves." AND ".$whereOcupada." AND ".$wherePlantaBaja." AND ".$whereEstado." ";};
                    if($_GET['op'] != '' AND $_GET['tipo'] != '' AND $_GET['ciudad'] != '' AND $_GET['zona'] != '' AND $_GET['preciodesde'] != '' AND $_GET['habitacionesdesde'] != '' AND $_GET['domicilio'] == '' AND $_GET['ref'] != '' AND $_GET['pileta'] != '' AND $_GET['llaves'] != '' AND $_GET['ocupada'] != '' AND $_GET['plantabaja'] != '' AND $_GET['estado'] != ''){$filtro = "WHERE ".$whereOp." AND ".$whereTipo." AND ".$whereCiudad." AND ".$whereTipo." AND ".$whereTipo." AND ".$whereHabitaciones." AND ".$whereRef." AND ".$wherePileta." AND ".$whereLlaves." AND ".$whereOcupada." AND ".$wherePlantaBaja." AND ".$whereEstado." ";};
                    if($_GET['op'] != '' AND $_GET['tipo'] != '' AND $_GET['ciudad'] != '' AND $_GET['zona'] != '' AND $_GET['preciodesde'] != '' AND $_GET['habitacionesdesde'] == '' AND $_GET['domicilio'] != '' AND $_GET['ref'] != '' AND $_GET['pileta'] != '' AND $_GET['llaves'] != '' AND $_GET['ocupada'] != '' AND $_GET['plantabaja'] != '' AND $_GET['estado'] != ''){$filtro = "WHERE ".$whereOp." AND ".$whereTipo." AND ".$whereCiudad." AND ".$whereTipo." AND ".$whereTipo." AND ".$whereDomicilio." AND ".$whereRef." AND ".$wherePileta." AND ".$whereLlaves." AND ".$whereOcupada." AND ".$wherePlantaBaja." AND ".$whereEstado." ";};
                    if($_GET['op'] != '' AND $_GET['tipo'] != '' AND $_GET['ciudad'] != '' AND $_GET['zona'] != '' AND $_GET['preciodesde'] == '' AND $_GET['habitacionesdesde'] != '' AND $_GET['domicilio'] != '' AND $_GET['ref'] != '' AND $_GET['pileta'] != '' AND $_GET['llaves'] != '' AND $_GET['ocupada'] != '' AND $_GET['plantabaja'] != '' AND $_GET['estado'] != ''){$filtro = "WHERE ".$whereOp." AND ".$whereTipo." AND ".$whereCiudad." AND ".$whereTipo." AND ".$whereHabitaciones." AND ".$whereDomicilio." AND ".$whereRef." AND ".$wherePileta." AND ".$whereLlaves." AND ".$whereOcupada." AND ".$wherePlantaBaja." AND ".$whereEstado." ";};
                    if($_GET['op'] != '' AND $_GET['tipo'] != '' AND $_GET['ciudad'] != '' AND $_GET['zona'] == '' AND $_GET['preciodesde'] != '' AND $_GET['habitacionesdesde'] != '' AND $_GET['domicilio'] != '' AND $_GET['ref'] != '' AND $_GET['pileta'] != '' AND $_GET['llaves'] != '' AND $_GET['ocupada'] != '' AND $_GET['plantabaja'] != '' AND $_GET['estado'] != ''){$filtro = "WHERE ".$whereOp." AND ".$whereTipo." AND ".$whereCiudad." AND ".$whereTipo." AND ".$whereHabitaciones." AND ".$whereDomicilio." AND ".$whereRef." AND ".$wherePileta." AND ".$whereLlaves." AND ".$whereOcupada." AND ".$wherePlantaBaja." AND ".$whereEstado." ";};
                    if($_GET['op'] != '' AND $_GET['tipo'] != '' AND $_GET['ciudad'] == '' AND $_GET['zona'] != '' AND $_GET['preciodesde'] != '' AND $_GET['habitacionesdesde'] != '' AND $_GET['domicilio'] != '' AND $_GET['ref'] != '' AND $_GET['pileta'] != '' AND $_GET['llaves'] != '' AND $_GET['ocupada'] != '' AND $_GET['plantabaja'] != '' AND $_GET['estado'] != ''){$filtro = "WHERE ".$whereOp." AND ".$whereTipo." AND ".$whereTipo." AND ".$whereTipo." AND ".$whereHabitaciones." AND ".$whereDomicilio." AND ".$whereRef." AND ".$wherePileta." AND ".$whereLlaves." AND ".$whereOcupada." AND ".$wherePlantaBaja." AND ".$whereEstado." ";};
                    if($_GET['op'] != '' AND $_GET['tipo'] == '' AND $_GET['ciudad'] != '' AND $_GET['zona'] != '' AND $_GET['preciodesde'] != '' AND $_GET['habitacionesdesde'] != '' AND $_GET['domicilio'] != '' AND $_GET['ref'] != '' AND $_GET['pileta'] != '' AND $_GET['llaves'] != '' AND $_GET['ocupada'] != '' AND $_GET['plantabaja'] != '' AND $_GET['estado'] != ''){$filtro = "WHERE ".$whereOp." AND ".$whereCiudad." AND ".$whereTipo." AND ".$whereTipo." AND ".$whereHabitaciones." AND ".$whereDomicilio." AND ".$whereRef." AND ".$wherePileta." AND ".$whereLlaves." AND ".$whereOcupada." AND ".$wherePlantaBaja." AND ".$whereEstado." ";};
                    if($_GET['op'] == '' AND $_GET['tipo'] != '' AND $_GET['ciudad'] != '' AND $_GET['zona'] != '' AND $_GET['preciodesde'] != '' AND $_GET['habitacionesdesde'] != '' AND $_GET['domicilio'] != '' AND $_GET['ref'] != '' AND $_GET['pileta'] != '' AND $_GET['llaves'] != '' AND $_GET['ocupada'] != '' AND $_GET['plantabaja'] != '' AND $_GET['estado'] != ''){$filtro = "WHERE ".$whereTipo." AND ".$whereCiudad." AND ".$whereTipo." AND ".$whereTipo." AND ".$whereHabitaciones." AND ".$whereDomicilio." AND ".$whereRef." AND ".$wherePileta." AND ".$whereLlaves." AND ".$whereOcupada." AND ".$wherePlantaBaja." AND ".$whereEstado." ";};
                    if($_GET['op'] == '' AND $_GET['tipo'] == '' AND $_GET['ciudad'] != '' AND $_GET['zona'] != '' AND $_GET['preciodesde'] != '' AND $_GET['habitacionesdesde'] != '' AND $_GET['domicilio'] != '' AND $_GET['ref'] != '' AND $_GET['pileta'] != '' AND $_GET['llaves'] != '' AND $_GET['ocupada'] != '' AND $_GET['plantabaja'] != '' AND $_GET['estado'] != ''){$filtro = "WHERE ".$whereCiudad." AND ".$whereTipo." AND ".$whereTipo." AND ".$whereHabitaciones." AND ".$whereDomicilio." AND ".$whereRef." AND ".$wherePileta." AND ".$whereLlaves." AND ".$whereOcupada." AND ".$wherePlantaBaja." AND ".$whereEstado." ";};
                    if($_GET['op'] == '' AND $_GET['tipo'] != '' AND $_GET['ciudad'] == '' AND $_GET['zona'] != '' AND $_GET['preciodesde'] != '' AND $_GET['habitacionesdesde'] != '' AND $_GET['domicilio'] != '' AND $_GET['ref'] != '' AND $_GET['pileta'] != '' AND $_GET['llaves'] != '' AND $_GET['ocupada'] != '' AND $_GET['plantabaja'] != '' AND $_GET['estado'] != ''){$filtro = "WHERE ".$whereTipo." AND ".$whereTipo." AND ".$whereTipo." AND ".$whereHabitaciones." AND ".$whereDomicilio." AND ".$whereRef." AND ".$wherePileta." AND ".$whereLlaves." AND ".$whereOcupada." AND ".$wherePlantaBaja." AND ".$whereEstado." ";};
                    if($_GET['op'] == '' AND $_GET['tipo'] != '' AND $_GET['ciudad'] != '' AND $_GET['zona'] == '' AND $_GET['preciodesde'] != '' AND $_GET['habitacionesdesde'] != '' AND $_GET['domicilio'] != '' AND $_GET['ref'] != '' AND $_GET['pileta'] != '' AND $_GET['llaves'] != '' AND $_GET['ocupada'] != '' AND $_GET['plantabaja'] != '' AND $_GET['estado'] != ''){$filtro = "WHERE ".$whereTipo." AND ".$whereCiudad." AND ".$whereTipo." AND ".$whereHabitaciones." AND ".$whereDomicilio." AND ".$whereRef." AND ".$wherePileta." AND ".$whereLlaves." AND ".$whereOcupada." AND ".$wherePlantaBaja." AND ".$whereEstado." ";};
                    if($_GET['op'] == '' AND $_GET['tipo'] != '' AND $_GET['ciudad'] != '' AND $_GET['zona'] != '' AND $_GET['preciodesde'] == '' AND $_GET['habitacionesdesde'] != '' AND $_GET['domicilio'] != '' AND $_GET['ref'] != '' AND $_GET['pileta'] != '' AND $_GET['llaves'] != '' AND $_GET['ocupada'] != '' AND $_GET['plantabaja'] != '' AND $_GET['estado'] != ''){$filtro = "WHERE ".$whereTipo." AND ".$whereCiudad." AND ".$whereTipo." AND ".$whereHabitaciones." AND ".$whereDomicilio." AND ".$whereRef." AND ".$wherePileta." AND ".$whereLlaves." AND ".$whereOcupada." AND ".$wherePlantaBaja." AND ".$whereEstado." ";};
                    if($_GET['op'] == '' AND $_GET['tipo'] != '' AND $_GET['ciudad'] != '' AND $_GET['zona'] != '' AND $_GET['preciodesde'] != '' AND $_GET['habitacionesdesde'] == '' AND $_GET['domicilio'] != '' AND $_GET['ref'] != '' AND $_GET['pileta'] != '' AND $_GET['llaves'] != '' AND $_GET['ocupada'] != '' AND $_GET['plantabaja'] != '' AND $_GET['estado'] != ''){$filtro = "WHERE ".$whereTipo." AND ".$whereCiudad." AND ".$whereTipo." AND ".$whereTipo." AND ".$whereDomicilio." AND ".$whereRef." AND ".$wherePileta." AND ".$whereLlaves." AND ".$whereOcupada." AND ".$wherePlantaBaja." AND ".$whereEstado." ";};
                    if($_GET['op'] == '' AND $_GET['tipo'] != '' AND $_GET['ciudad'] != '' AND $_GET['zona'] != '' AND $_GET['preciodesde'] != '' AND $_GET['habitacionesdesde'] != '' AND $_GET['domicilio'] == '' AND $_GET['ref'] != '' AND $_GET['pileta'] != '' AND $_GET['llaves'] != '' AND $_GET['ocupada'] != '' AND $_GET['plantabaja'] != '' AND $_GET['estado'] != ''){$filtro = "WHERE ".$whereTipo." AND ".$whereCiudad." AND ".$whereTipo." AND ".$whereTipo." AND ".$whereHabitaciones." AND ".$whereRef." AND ".$wherePileta." AND ".$whereLlaves." AND ".$whereOcupada." AND ".$wherePlantaBaja." AND ".$whereEstado." ";};
                    if($_GET['op'] == '' AND $_GET['tipo'] != '' AND $_GET['ciudad'] != '' AND $_GET['zona'] != '' AND $_GET['preciodesde'] != '' AND $_GET['habitacionesdesde'] != '' AND $_GET['domicilio'] != '' AND $_GET['ref'] == '' AND $_GET['pileta'] != '' AND $_GET['llaves'] != '' AND $_GET['ocupada'] != '' AND $_GET['plantabaja'] != '' AND $_GET['estado'] != ''){$filtro = "WHERE ".$whereTipo." AND ".$whereCiudad." AND ".$whereTipo." AND ".$whereTipo." AND ".$whereHabitaciones." AND ".$whereDomicilio." AND ".$wherePileta." AND ".$whereLlaves." AND ".$whereOcupada." AND ".$wherePlantaBaja." AND ".$whereEstado." ";};
                    if($_GET['op'] == '' AND $_GET['tipo'] != '' AND $_GET['ciudad'] != '' AND $_GET['zona'] != '' AND $_GET['preciodesde'] != '' AND $_GET['habitacionesdesde'] != '' AND $_GET['domicilio'] != '' AND $_GET['ref'] != '' AND $_GET['pileta'] == '' AND $_GET['llaves'] != '' AND $_GET['ocupada'] != '' AND $_GET['plantabaja'] != '' AND $_GET['estado'] != ''){$filtro = "WHERE ".$whereTipo." AND ".$whereCiudad." AND ".$whereTipo." AND ".$whereTipo." AND ".$whereHabitaciones." AND ".$whereDomicilio." AND ".$whereRef." AND ".$whereLlaves." AND ".$whereOcupada." AND ".$wherePlantaBaja." AND ".$whereEstado." ";};
                    if($_GET['op'] == '' AND $_GET['tipo'] != '' AND $_GET['ciudad'] != '' AND $_GET['zona'] != '' AND $_GET['preciodesde'] != '' AND $_GET['habitacionesdesde'] != '' AND $_GET['domicilio'] != '' AND $_GET['ref'] != '' AND $_GET['pileta'] != '' AND $_GET['llaves'] == '' AND $_GET['ocupada'] != '' AND $_GET['plantabaja'] != '' AND $_GET['estado'] != ''){$filtro = "WHERE ".$whereTipo." AND ".$whereCiudad." AND ".$whereTipo." AND ".$whereTipo." AND ".$whereHabitaciones." AND ".$whereDomicilio." AND ".$whereRef." AND ".$wherePileta." AND ".$whereLlaves." AND ".$whereOcupada." AND ".$wherePlantaBaja." AND ".$whereEstado." ";};
                    if($_GET['op'] == '' AND $_GET['tipo'] != '' AND $_GET['ciudad'] != '' AND $_GET['zona'] != '' AND $_GET['preciodesde'] != '' AND $_GET['habitacionesdesde'] != '' AND $_GET['domicilio'] != '' AND $_GET['ref'] != '' AND $_GET['pileta'] != '' AND $_GET['llaves'] != '' AND $_GET['ocupada'] == '' AND $_GET['plantabaja'] != '' AND $_GET['estado'] != ''){$filtro = "WHERE ".$whereTipo." AND ".$whereCiudad." AND ".$whereTipo." AND ".$whereTipo." AND ".$whereHabitaciones." AND ".$whereDomicilio." AND ".$whereRef." AND ".$wherePileta." AND ".$whereLlaves." AND ".$wherePlantaBaja." AND ".$whereEstado." ";};
                    if($_GET['op'] == '' AND $_GET['tipo'] != '' AND $_GET['ciudad'] != '' AND $_GET['zona'] != '' AND $_GET['preciodesde'] != '' AND $_GET['habitacionesdesde'] != '' AND $_GET['domicilio'] != '' AND $_GET['ref'] != '' AND $_GET['pileta'] != '' AND $_GET['llaves'] != '' AND $_GET['ocupada'] != '' AND $_GET['plantabaja'] == '' AND $_GET['estado'] != ''){$filtro = "WHERE ".$whereTipo." AND ".$whereCiudad." AND ".$whereTipo." AND ".$whereTipo." AND ".$whereHabitaciones." AND ".$whereDomicilio." AND ".$whereRef." AND ".$wherePileta." AND ".$whereLlaves." AND ".$whereOcupada." AND ".$whereEstado." ";};
                    if($_GET['op'] == '' AND $_GET['tipo'] != '' AND $_GET['ciudad'] != '' AND $_GET['zona'] != '' AND $_GET['preciodesde'] != '' AND $_GET['habitacionesdesde'] != '' AND $_GET['domicilio'] != '' AND $_GET['ref'] != '' AND $_GET['pileta'] != '' AND $_GET['llaves'] != '' AND $_GET['ocupada'] != '' AND $_GET['plantabaja'] != '' AND $_GET['estado'] == ''){$filtro = "WHERE ".$whereTipo." AND ".$whereCiudad." AND ".$whereTipo." AND ".$whereTipo." AND ".$whereHabitaciones." AND ".$whereDomicilio." AND ".$whereRef." AND ".$wherePileta." AND ".$whereLlaves." AND ".$whereOcupada." AND ".$wherePlantaBaja." ";};
                    if($_GET['op'] != '' AND $_GET['tipo'] == '' AND $_GET['ciudad'] == '' AND $_GET['zona'] != '' AND $_GET['preciodesde'] != '' AND $_GET['habitacionesdesde'] != '' AND $_GET['domicilio'] != '' AND $_GET['ref'] != '' AND $_GET['pileta'] != '' AND $_GET['llaves'] != '' AND $_GET['ocupada'] != '' AND $_GET['plantabaja'] != '' AND $_GET['estado'] != ''){$filtro = "WHERE ".$whereOp." AND ".$whereTipo." AND ".$whereTipo." AND ".$whereHabitaciones." AND ".$whereDomicilio." AND ".$whereRef." AND ".$wherePileta." AND ".$whereLlaves." AND ".$whereOcupada." AND ".$wherePlantaBaja." AND ".$whereEstado." ";};
                    if($_GET['op'] != '' AND $_GET['tipo'] == '' AND $_GET['ciudad'] != '' AND $_GET['zona'] == '' AND $_GET['preciodesde'] != '' AND $_GET['habitacionesdesde'] != '' AND $_GET['domicilio'] != '' AND $_GET['ref'] != '' AND $_GET['pileta'] != '' AND $_GET['llaves'] != '' AND $_GET['ocupada'] != '' AND $_GET['plantabaja'] != '' AND $_GET['estado'] != ''){$filtro = "WHERE ".$whereOp." AND ".$whereCiudad." AND ".$whereTipo." AND ".$whereHabitaciones." AND ".$whereDomicilio." AND ".$whereRef." AND ".$wherePileta." AND ".$whereLlaves." AND ".$whereOcupada." AND ".$wherePlantaBaja." AND ".$whereEstado." ";};
                    if($_GET['op'] != '' AND $_GET['tipo'] == '' AND $_GET['ciudad'] != '' AND $_GET['zona'] != '' AND $_GET['preciodesde'] == '' AND $_GET['habitacionesdesde'] != '' AND $_GET['domicilio'] != '' AND $_GET['ref'] != '' AND $_GET['pileta'] != '' AND $_GET['llaves'] != '' AND $_GET['ocupada'] != '' AND $_GET['plantabaja'] != '' AND $_GET['estado'] != ''){$filtro = "WHERE ".$whereOp." AND ".$whereCiudad." AND ".$whereTipo." AND ".$whereHabitaciones." AND ".$whereDomicilio." AND ".$whereRef." AND ".$wherePileta." AND ".$whereLlaves." AND ".$whereOcupada." AND ".$wherePlantaBaja." AND ".$whereEstado." ";};
                    if($_GET['op'] != '' AND $_GET['tipo'] == '' AND $_GET['ciudad'] != '' AND $_GET['zona'] != '' AND $_GET['preciodesde'] != '' AND $_GET['habitacionesdesde'] == '' AND $_GET['domicilio'] != '' AND $_GET['ref'] != '' AND $_GET['pileta'] != '' AND $_GET['llaves'] != '' AND $_GET['ocupada'] != '' AND $_GET['plantabaja'] != '' AND $_GET['estado'] != ''){$filtro = "WHERE ".$whereOp." AND ".$whereCiudad." AND ".$whereTipo." AND ".$whereTipo." AND ".$whereDomicilio." AND ".$whereRef." AND ".$wherePileta." AND ".$whereLlaves." AND ".$whereOcupada." AND ".$wherePlantaBaja." AND ".$whereEstado." ";};
                    if($_GET['op'] != '' AND $_GET['tipo'] == '' AND $_GET['ciudad'] != '' AND $_GET['zona'] != '' AND $_GET['preciodesde'] != '' AND $_GET['habitacionesdesde'] != '' AND $_GET['domicilio'] == '' AND $_GET['ref'] != '' AND $_GET['pileta'] != '' AND $_GET['llaves'] != '' AND $_GET['ocupada'] != '' AND $_GET['plantabaja'] != '' AND $_GET['estado'] != ''){$filtro = "WHERE ".$whereOp." AND ".$whereCiudad." AND ".$whereTipo." AND ".$whereTipo." AND ".$whereHabitaciones." AND ".$whereRef." AND ".$wherePileta." AND ".$whereLlaves." AND ".$whereOcupada." AND ".$wherePlantaBaja." AND ".$whereEstado." ";};
                    if($_GET['op'] != '' AND $_GET['tipo'] == '' AND $_GET['ciudad'] != '' AND $_GET['zona'] != '' AND $_GET['preciodesde'] != '' AND $_GET['habitacionesdesde'] != '' AND $_GET['domicilio'] != '' AND $_GET['ref'] == '' AND $_GET['pileta'] != '' AND $_GET['llaves'] != '' AND $_GET['ocupada'] != '' AND $_GET['plantabaja'] != '' AND $_GET['estado'] != ''){$filtro = "WHERE ".$whereOp." AND ".$whereCiudad." AND ".$whereTipo." AND ".$whereTipo." AND ".$whereHabitaciones." AND ".$whereDomicilio." AND ".$wherePileta." AND ".$whereLlaves." AND ".$whereOcupada." AND ".$wherePlantaBaja." AND ".$whereEstado." ";};
                    if($_GET['op'] != '' AND $_GET['tipo'] == '' AND $_GET['ciudad'] != '' AND $_GET['zona'] != '' AND $_GET['preciodesde'] != '' AND $_GET['habitacionesdesde'] != '' AND $_GET['domicilio'] != '' AND $_GET['ref'] != '' AND $_GET['pileta'] == '' AND $_GET['llaves'] != '' AND $_GET['ocupada'] != '' AND $_GET['plantabaja'] != '' AND $_GET['estado'] != ''){$filtro = "WHERE ".$whereOp." AND ".$whereCiudad." AND ".$whereTipo." AND ".$whereTipo." AND ".$whereHabitaciones." AND ".$whereDomicilio." AND ".$whereRef." AND ".$whereLlaves." AND ".$whereOcupada." AND ".$wherePlantaBaja." AND ".$whereEstado." ";};
                    if($_GET['op'] != '' AND $_GET['tipo'] == '' AND $_GET['ciudad'] != '' AND $_GET['zona'] != '' AND $_GET['preciodesde'] != '' AND $_GET['habitacionesdesde'] != '' AND $_GET['domicilio'] != '' AND $_GET['ref'] != '' AND $_GET['pileta'] != '' AND $_GET['llaves'] == '' AND $_GET['ocupada'] != '' AND $_GET['plantabaja'] != '' AND $_GET['estado'] != ''){$filtro = "WHERE ".$whereOp." AND ".$whereCiudad." AND ".$whereTipo." AND ".$whereTipo." AND ".$whereHabitaciones." AND ".$whereDomicilio." AND ".$whereRef." AND ".$wherePileta." AND ".$whereOcupada." AND ".$wherePlantaBaja." AND ".$whereEstado." ";};
                    if($_GET['op'] != '' AND $_GET['tipo'] == '' AND $_GET['ciudad'] != '' AND $_GET['zona'] != '' AND $_GET['preciodesde'] != '' AND $_GET['habitacionesdesde'] != '' AND $_GET['domicilio'] != '' AND $_GET['ref'] != '' AND $_GET['pileta'] != '' AND $_GET['llaves'] != '' AND $_GET['ocupada'] == '' AND $_GET['plantabaja'] != '' AND $_GET['estado'] != ''){$filtro = "WHERE ".$whereOp." AND ".$whereCiudad." AND ".$whereTipo." AND ".$whereTipo." AND ".$whereHabitaciones." AND ".$whereDomicilio." AND ".$whereRef." AND ".$wherePileta." AND ".$whereLlaves." AND ".$wherePlantaBaja." AND ".$whereEstado." ";};
                    if($_GET['op'] != '' AND $_GET['tipo'] == '' AND $_GET['ciudad'] != '' AND $_GET['zona'] != '' AND $_GET['preciodesde'] != '' AND $_GET['habitacionesdesde'] != '' AND $_GET['domicilio'] != '' AND $_GET['ref'] != '' AND $_GET['pileta'] != '' AND $_GET['llaves'] != '' AND $_GET['ocupada'] != '' AND $_GET['plantabaja'] == '' AND $_GET['estado'] != ''){$filtro = "WHERE ".$whereOp." AND ".$whereCiudad." AND ".$whereTipo." AND ".$whereTipo." AND ".$whereHabitaciones." AND ".$whereDomicilio." AND ".$whereRef." AND ".$wherePileta." AND ".$whereLlaves." AND ".$whereOcupada." AND ".$whereEstado." ";};
                    ...
                    <?php
                        ...
                        if($_GET['op'] == '' AND $_GET['tipo'] != '' AND $_GET['ciudad'] == '' AND $_GET['zona'] == '' AND $_GET['preciodesde'] == '' AND $_GET['habitacionesdesde'] == '' AND $_GET['domicilio'] == '' AND $_GET['ref'] == '' AND $_GET['pileta'] == '' AND $_GET['llaves'] == '' AND $_GET['ocupada'] == '' AND $_GET['plantabaja'] == '' AND $_GET['estado'] == ''){$filtro = "WHERE ".$whereTipo." ";};
                        if($_GET['op'] == '' AND $_GET['tipo'] == '' AND $_GET['ciudad'] != '' AND $_GET['zona'] == '' AND $_GET['preciodesde'] == '' AND $_GET['habitacionesdesde'] == '' AND $_GET['domicilio'] == '' AND $_GET['ref'] == '' AND $_GET['pileta'] == '' AND $_GET['llaves'] == '' AND $_GET['ocupada'] == '' AND $_GET['plantabaja'] == '' AND $_GET['estado'] == ''){$filtro = "WHERE ".$whereCiudad." ";};
                        if($_GET['op'] == '' AND $_GET['tipo'] == '' AND $_GET['ciudad'] == '' AND $_GET['zona'] != '' AND $_GET['preciodesde'] == '' AND $_GET['habitacionesdesde'] == '' AND $_GET['domicilio'] == '' AND $_GET['ref'] == '' AND $_GET['pileta'] == '' AND $_GET['llaves'] == '' AND $_GET['ocupada'] == '' AND $_GET['plantabaja'] == '' AND $_GET['estado'] == ''){$filtro = "WHERE ".$whereZona." ";};
                        if($_GET['op'] == '' AND $_GET['tipo'] == '' AND $_GET['ciudad'] == '' AND $_GET['zona'] == '' AND $_GET['preciodesde'] != '' AND $_GET['habitacionesdesde'] == '' AND $_GET['domicilio'] == '' AND $_GET['ref'] == '' AND $_GET['pileta'] == '' AND $_GET['llaves'] == '' AND $_GET['ocupada'] == '' AND $_GET['plantabaja'] == '' AND $_GET['estado'] == ''){$filtro = "WHERE ".$wherePrecio." ";};
                        if($_GET['op'] == '' AND $_GET['tipo'] == '' AND $_GET['ciudad'] == '' AND $_GET['zona'] == '' AND $_GET['preciodesde'] == '' AND $_GET['habitacionesdesde'] != '' AND $_GET['domicilio'] == '' AND $_GET['ref'] == '' AND $_GET['pileta'] == '' AND $_GET['llaves'] == '' AND $_GET['ocupada'] == '' AND $_GET['plantabaja'] == '' AND $_GET['estado'] == ''){$filtro = "WHERE ".$whereHabitaciones." ";};
                        if($_GET['op'] == '' AND $_GET['tipo'] == '' AND $_GET['ciudad'] == '' AND $_GET['zona'] == '' AND $_GET['preciodesde'] == '' AND $_GET['habitacionesdesde'] == '' AND $_GET['domicilio'] != '' AND $_GET['ref'] == '' AND $_GET['pileta'] == '' AND $_GET['llaves'] == '' AND $_GET['ocupada'] == '' AND $_GET['plantabaja'] == '' AND $_GET['estado'] == ''){$filtro = "WHERE ".$whereDomicilio." ";};
                        if($_GET['op'] == '' AND $_GET['tipo'] == '' AND $_GET['ciudad'] == '' AND $_GET['zona'] == '' AND $_GET['preciodesde'] == '' AND $_GET['habitacionesdesde'] == '' AND $_GET['domicilio'] == '' AND $_GET['ref'] != '' AND $_GET['pileta'] == '' AND $_GET['llaves'] == '' AND $_GET['ocupada'] == '' AND $_GET['plantabaja'] == '' AND $_GET['estado'] == ''){$filtro = "WHERE ".$whereRef." ";};
                        if($_GET['op'] == '' AND $_GET['tipo'] == '' AND $_GET['ciudad'] == '' AND $_GET['zona'] == '' AND $_GET['preciodesde'] == '' AND $_GET['habitacionesdesde'] == '' AND $_GET['domicilio'] == '' AND $_GET['ref'] == '' AND $_GET['pileta'] != '' AND $_GET['llaves'] == '' AND $_GET['ocupada'] == '' AND $_GET['plantabaja'] == '' AND $_GET['estado'] == ''){$filtro = "WHERE ".$wherePileta." ";};
